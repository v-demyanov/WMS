...
namespace WMS.Database.Migrations
{
    ...
    [Migration("20230424135158_AddReceivingAndShippingDateFieldsToWare")]
    partial class AddReceivingAndShippingDateFieldsToWare
    {
            ...
            modelBuilder.Entity("WMS.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Vladislav",
                            LastName = "Demyanov",
                            Password = "6A2BFDF0CDDD82533AF32C21A18217E1CFB0974AC02FD779C0785A608D904B92",
                            Role = 0,
                            Salt = "3F890434F5D4FB9630E38DE04BCFC2CD"
                        });
                });
