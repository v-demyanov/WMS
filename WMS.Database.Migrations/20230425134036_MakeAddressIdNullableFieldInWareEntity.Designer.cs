...
namespace WMS.Database.Migrations
{
    ...
    [Migration("20230425134036_MakeAddressIdNullableFieldInWareEntity")]
    partial class MakeAddressIdNullableFieldInWareEntity
    {
            ...
            modelBuilder.Entity("WMS.Database.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Vladislav",
                            LastName = "Demyanov",
                            Password = "EB205B498A93752944C57C97054A2B9C88B51E92EB603479267DAC70603E2BC0",
                            Role = 0,
                            Salt = "8C7D10F8E2A138A001C9C6CDD26D2733"
                        });
                });
