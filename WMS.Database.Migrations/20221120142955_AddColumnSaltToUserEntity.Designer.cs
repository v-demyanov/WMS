...
namespace WMS.Database.Migrations
{
    ...
    [Migration("20221120142955_AddColumnSaltToUserEntity")]
    partial class AddColumnSaltToUserEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Database.Entities.Tenants.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMS.Database.Entities.Tenants.Individual", b =>
                {
                    b.HasOne("WMS.Database.Entities.Tenants.Tenant", "Tenant")
                        .WithOne("Individual")
                        .HasForeignKey("WMS.Database.Entities.Tenants.Individual", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WMS.Database.Entities.Tenants.LegalEntity", b =>
                {
                    b.HasOne("WMS.Database.Entities.Tenants.Tenant", "Tenant")
                        .WithOne("LegalEntity")
                        .HasForeignKey("WMS.Database.Entities.Tenants.LegalEntity", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
